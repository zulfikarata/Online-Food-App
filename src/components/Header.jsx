        ...
        <div className=' flex-nowrap flex items-center justify-between max-w-6xl  w-full pr-4 pl-4 mr-auto ml-auto md:gap-x-28'>
         <div className='flex items-center justify-between flex-1'>
            ...
            <div className='relative w-2/3 m-0 block '>
               <input type="text" placeholder='Bir ürün ya da restoran arayın' className=" text-sm font-normal p-4 rounded-xl border border-solid border-gray-400 block w-full h-10 leading-6 text-gray-400 bg-white  bg-clip-padding transition-colors overflow-visible m-0 text-inherit" />
         ...
         <div className=' flex-initial flex items-center '>
            <div className=' flex-row ml-auto  items-center flex pl-0 mb-0 list-none'>
               ...
               <button type='button' onClick={()=>router.push('/pages/basket')} className='pr-0 text-sm font-bold text-black inline-flex whitespace-nowrap items-center relative pl-2 p-2 bg-transparent '>
                  <div className='bg-red-600 flex flex-row items-center rounded-3xl h-11 w-32 transition-all'>
