                                ...
                                <div className='w-full object-cover overflow-hidden'>
                                    <div className='h-full'>
                                        <figure className='w-full h-full flex items-center justify-center overflow-hidden m-0'>
                                            <Image className='rounded-none object-cover bg-transparent border-none' src={'/king.jpeg'} alt='Burger' width={1000} height={1000}/>
                                        </figure>
                                    </div>
                                </div>
                                <div className='m-0 p-6 flex-col w-full relative overflow-hidden flex'>
                                   <div className='flex-col w-3/12 flex items-start'>
                                    <h1 className='flex justify-between items-center not-italic font-semibold text-base leading-6 text-yellow-600 '>Burger King</h1>
                                   </div>
                                                    ...
                                                    <div className=' select-none inline-flex text-yellow-600 bg-transparent border-0 p-0 rounded-none'>
                                                        <button className=' items-start p-0 appearance h-full w-full inline-flex justify-center font-semibold leading-4 outline-0 border-0 cursor-pointer bg-inherit text-inherit border-inherit'>
                                                            <div className=' w-28 h-20 m-2 rounded-sm object-cover overflow-hidden relative'>
                                                                <figure className='w-full h-full flex items-center justify-center overflow-hidden m-0'>
                                                                    <Image className=' object-contain rounded-md bg-transparent border-none' src={'/menu4.webp'} alt='' width={100} height={100}/>
                                                                </figure>
                                                            </div>
                                                        </button>
                                                    </div>
                                                        ...
                                                        <div className=' flex-col items-start justify-start max-w-md m-0 w-auto flex relative text-yellow-600'>
                                                            <div className=' select-none inline-flex text-yellow-600 bg-transparent border-0 p-0 rounded-none'>
                                                                <button className=' p-0 w-full h-full inline-flex items-center justify-center font-semibold leading-4 outline-0 border-0 cursor-pointer bg-inherit text-inherit border-inherit'>
                                                                    <h4 className=' font-semibold text-ellipsis text-lg leading-6 text-black text-left overflow-hidden'>Köfte Burger Menü</h4>
                                                                </button>
                                                            </div>
                                                            <div className='mt-2'>
                                                                <p className='text-xs  leading-4 font-normal text-gray-400 '>Köfte burger(1 adet), büyük cips ve içecek(Ayran) ile</p>
                                                            </div>
                                                        </div>
                                                ...
                                                <div className=' rounded-none flex-row p-0  flex justify-between w-full bg-white shadow-md font-semibold text-base'>
                                                    <div className=' select-none inline-flex text-yellow-600 bg-transparent border-0 p-0 rounded-none'>
                                                        <button className=' items-start p-0 appearance h-full w-full inline-flex justify-center font-semibold leading-4 outline-0 border-0 cursor-pointer bg-inherit text-inherit border-inherit'>
                                                            <div className=' w-28 h-20 m-2 rounded-sm object-cover overflow-hidden relative'>
                                                                <figure className='w-full h-full flex items-center justify-center overflow-hidden m-0'>
                                                                    <Image className=' object-contain rounded-md bg-transparent border-none' src={'/whopper.png'} alt='' width={100} height={100}/>
                                                                </figure>
                                                            </div>
                                                        </button>
                                                    </div>
                                                    <div className=' flex-col flex-1 flex p-6 '>
                                                        <div className=' flex-col items-start justify-start max-w-md m-0 w-auto flex relative text-yellow-600'>
                                                            <div className=' select-none inline-flex text-yellow-600 bg-transparent border-0 p-0 rounded-none'>
                                                                <button className=' p-0 w-full h-full inline-flex items-center justify-center font-semibold leading-4 outline-0 border-0 cursor-pointer bg-inherit text-inherit border-inherit'>
                                                                    <h4 className=' font-semibold text-ellipsis text-lg leading-6 text-black text-left overflow-hidden'>Whopper Menü</h4>
                                                                </button>
                                                            </div>
                                                            <div className='mt-2'>
                                                                <p className='text-xs  leading-4 font-normal text-gray-400 '>Whopper®, Patates Kızartması (Orta) ve Kutu İçecek</p>
                                                            </div>
                                                        </div>
                                                        <div className=' flex-row pt-2 justify-between items-end flex-1 m-0 min-w-[105px] w-auto flex'>
                                                            <div className=' flex-row flex items-start'>
                                                                <span className=' pl-1 font-semibold text-base leading-6 text-yellow-600'>₺170,00</span>
                                                            </div>
                                                            <div className=' select-none inline-flex rounded-lg overflow-hidden border-2 border-solid bg-yellow-600 border-yellow-600 text-white shadow-md'>
                                                                <button className=' leading-5 p-1 w-full h-full inline-flex items-center justify-center font-semibold outline-0 border-0 cursor-pointer'>
                                                                    <div className=' inline-flex items-center justify-center min-w-[12px] min-h[12px]'>
                                                ...
                                                <div className=' rounded-none flex-row p-0  flex justify-between w-full bg-white shadow-md font-semibold text-base'>
                                                    <div className=' select-none inline-flex text-yellow-600 bg-transparent border-0 p-0 rounded-none'>
                                                        <button className=' items-start p-0 appearance h-full w-full inline-flex justify-center font-semibold leading-4 outline-0 border-0 cursor-pointer bg-inherit text-inherit border-inherit'>
                                                            <div className=' w-28 h-20 m-2 rounded-sm object-cover overflow-hidden relative'>
                                                                <figure className='w-full h-full flex items-center justify-center overflow-hidden m-0'>
                                                                    <Image className=' object-contain rounded-md bg-transparent border-none' src={'/bigking.png'} alt='' width={100} height={100}/>
                                                                </figure>
                                                            </div>
                                                        </button>
                                                    </div>
                                                    <div className=' flex-col flex-1 flex p-6 '>
                                                        <div className=' flex-col items-start justify-start max-w-md m-0 w-auto flex relative text-yellow-600'>
                                                            <div className=' select-none inline-flex text-yellow-600 bg-transparent border-0 p-0 rounded-none'>
                                                                <button className=' p-0 w-full h-full inline-flex items-center justify-center font-semibold leading-4 outline-0 border-0 cursor-pointer bg-inherit text-inherit border-inherit'>
                                                                    <h4 className=' font-semibold text-ellipsis text-lg leading-6 text-black text-left overflow-hidden'>BigKing Menü</h4>
                                                                </button>
                                                            </div>
                                                            <div className='mt-2'>
                                                                <p className='text-xs  leading-4 font-normal text-gray-400 '>Big King®, Patates Kızartması (Orta) ve Kutu İçecek</p>
                                                            </div>
                                                        </div>
                                                        <div className=' flex-row pt-2 justify-between items-end flex-1 m-0 min-w-[105px] w-auto flex'>
                                                            <div className=' flex-row flex items-start'>
                                                                <span className=' pl-1 font-semibold text-base leading-6 text-yellow-600'>₺155,00</span>
                                                            </div>
                                                            <div className=' select-none inline-flex rounded-lg overflow-hidden border-2 border-solid bg-yellow-600 border-yellow-600 text-white shadow-md'>
                                                                <button className=' leading-5 p-1 w-full h-full inline-flex items-center justify-center font-semibold outline-0 border-0 cursor-pointer'>
                                                                    <div className=' inline-flex items-center justify-center min-w-[12px] min-h[12px]'>
